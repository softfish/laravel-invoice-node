...
new Vue({
    ...
    methods: {
        toggleEditOverwrite: function toggleEditOverwrite() {
            this.editOverwrite = !this.editOverwrite;
        },
        toggleLoadingMask: function toggleLoadingMask() {
        ...
        updateInvoiceAttributes: function updateInvoiceAttributes() {
            var _this = this;

            this.toggleLoadingMask();
            axios.put('/api/invoices/' + this.invoice.id, this.invoice).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this.maskon = true;
                    _this.alert.message = 'Invoice has been updated.';
                    _this.alert.type = 'success';
                    _this.invoice = response.invoice;
                } else {
                    _this.alert.message = response.error;
                    _this.alert.type = 'error';
                }
                _this.toggleLoadingMask();
        ...
        createNewBillEntry: function createNewBillEntry() {
            var _this2 = this;

            this.toggleLoadingMask();
            this.beForm.position = this.invoice.bill_entries.length;
            axios.post('/api/invoices/' + this.invoice.id + '/billentries', this.beForm).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this2.alert.message = 'New bill entry has been added to this invoice';
                    _this2.alert.type = 'success';
                    _this2.invoice = response.invoice;
                    _this2.beForm = {
                        description: null,
                        charge: null,
                        position: null
                    ...
                    _this2.alert.message = response.error;
                    _this2.alert.type = 'error';
                }
                _this2.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this2.toggleLoadingMask();
        ...
        removeExistingBillEntry: function removeExistingBillEntry(id) {
            var _this3 = this;

            this.toggleLoadingMask();
            axios.delete('/api/invoices/' + this.invoice.id + '/billentries/' + id).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this3.alert.message = 'Bill entry has been removed.';
                    _this3.alert.type = 'success';
                    _this3.invoice = response.invoice;
                } else {
                    _this3.alert.message = response.error;
                    _this3.alert.type = 'error';
                }
                _this3.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this3.toggleLoadingMask();
        ...
        updateBillEntriesOrder: function updateBillEntriesOrder() {
            // TODO to arrange the display order for the billentries in this invoice
        },
        reloadInvoiceObj: function reloadInvoiceObj() {
            var _this4 = this;

            this.toggleLoadingMask();
            this.refreshAlert();
            axios.get('/api/invoices/' + this.invoice.id).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this4.invoice = response.invoice;
                } else {
                    _this4.alert.message = response.error;
                    _this4.alert.type = 'error';
                }
                _this4.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this4.toggleLoadingMask();
        ...
        issueInvoice: function issueInvoice() {
            ...
            axios.put('/api/invoices/' + this.invoice.id, this.invoice).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this5.alert.message = 'Invoice has been issued.';
                    _this5.alert.type = 'success';
                    _this5.invoice = response.invoice;
                } else {
                    _this5.alert.message = response.error;
                    _this5.alert.type = 'error';
                }
                _this5.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this5.toggleLoadingMask();
        ...
        cancelInvoice: function cancelInvoice() {
            ...
            axios.put('/api/invoices/' + this.invoice.id, this.invoice).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this6.alert.message = 'Invoice has been cancelled.';
                    _this6.alert.type = 'success';
                    _this6.invoice = response.invoice;
                } else {
                    _this6.alert.message = response.error;
                    _this6.alert.type = 'error';
                }
                _this6.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this6.toggleLoadingMask();
        ...
        markInvoicePaid: function markInvoicePaid() {
            var _this7 = this;
            ...
            axios.put('/api/invoices/' + this.invoice.id, this.invoice).then(function (response) {
                response = response.data;
                if (response.success) {
                    _this7.alert.message = 'Invoice has been marked as paid.';
                    _this7.alert.type = 'success';
                    _this7.invoice = response.invoice;
                } else {
                    _this7.alert.message = response.error;
                    _this7.alert.type = 'error';
                }
                _this7.toggleLoadingMask();
            }).catch(function (error) {
                console.log(error);
                alert(error);
                _this7.toggleLoadingMask();
        ...
        refreshAlert: function refreshAlert() {
            this.alert = {
                message: null,
                type: null
            };
